...
<meta charset="UTF-8">
<title>菜单管理</title>
<link rel="stylesheet" href="/ly_2/menu/css/menu.css"/>
</head>
<body>
...
<script type="text/javascript" src="/ly_2/menu/js/jquery.js"></script>
<script type="text/javascript" src="/ly_2/menu/js/vue.js"></script>
<script type="text/javascript" src="/ly_2/menu/js/menu.js"></script>
